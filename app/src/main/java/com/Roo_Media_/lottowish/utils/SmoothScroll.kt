...
class SmoothLayout(val context: Context) : LinearLayoutManager(context) {
    ...
    inner class SmoothScroller(context: Context, val dy: Int) : LinearSmoothScroller(context) {
        override fun calculateSpeedPerPixel(displayMetrics: DisplayMetrics): Float {
            return (1.5 / dy).toFloat()
        }
    }
}
